...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Assets/JS/networking/communication/socket.js":[function(require,module,exports) {
// http://172.20.10.3:3000
// http://192.168.8.101
var socket = io.connect("https://laserspaceserver.herokuapp.com/", {
  port: 55256
});
...
socket.on('Sync', function (msg) {
  Object.entries(msg).forEach(function (p) {
    if (p[0] != playerID) {
      if (otherPlayers[p[0]]) {
        otherPlayers[p[0]].x = p[1].x;
        otherPlayers[p[0]].y = p[1].y; // console.log( [p[1].direction, 0, 0] );       

        otherPlayers[p[0]].transform.rotation = [p[1].direction, 0, 0]; // console.log( otherPlayers[ p[0] ].transform.rotation );  
      } else {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","Assets/JS/networking/communication/socket.js"], null)
//# sourceMappingURL=/socket.608c4c3a.js.map